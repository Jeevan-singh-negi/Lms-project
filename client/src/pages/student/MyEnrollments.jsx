...
function MyEnrollments() {
  ...
  // Temporary hardcoded progress (should come from real progress tracking logic)
        ...
        <table className="md:table-auto table-fixed w-full mt-10 overflow-hidden border">
          ...
          <tbody className="text-gray-700">
            {enrolledCourses.map((course, index) => {
              ...
              const lectureCompleted = progress?.lectureCompleted || 0;
              const totalLecture = progress?.totalLecture || 1;
              const percentage = (lectureCompleted * 100) / totalLecture;
              ...
              return (
                <tr key={course._id} className="border-b border-gray-500/20">
                  ...
                  <td className="px-4 py-3 max-sm:hidden">
                    {lectureCompleted} / {totalLecture} <span>Lectures</span>
                  </td>
